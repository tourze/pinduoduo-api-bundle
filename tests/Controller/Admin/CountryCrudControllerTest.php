...
final class CountryCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    public function testIndexPageRequiresAuthentication(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/country');
    ...
    public function testValidationErrors(): void
    {
        ...
        try {
            $crawler = $client->request('GET', '/pinduoduo-api/country?crudAction=new');
    ...
    public function testSearchFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/country?query=test');
            $response = $client->getResponse();
    ...
    public function testFilterFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/country?filters[countryId]=1');
            $response = $client->getResponse();
    ...
    public function testDetailPageAccess(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/country?crudAction=detail&entityId=1');
            $response = $client->getResponse();
