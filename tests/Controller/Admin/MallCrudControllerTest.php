 ...
 * @internal
 */
#[CoversClass(MallCrudController::class)]
#[RunTestsInSeparateProcesses]
final class MallCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    public function testIndexPageRequiresAuthentication(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/mall');
    ...
    public function testValidationErrors(): void
    {
        ...
        try {
            $crawler = $client->request('GET', '/pinduoduo-api/mall?crudAction=new');
    ...
    public function testSearchFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/mall?query=test');
            $response = $client->getResponse();
    ...
    public function testFilterFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/mall?filters[mallId]=1');
            $response = $client->getResponse();
    ...
    public function testDetailPageAccess(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/mall?crudAction=detail&entityId=1');
            $response = $client->getResponse();
    ...
    protected function getControllerService(): MallCrudController
    {
        return self::getService(MallCrudController::class);
    }
    ...
    public static function provideNewPageFields(): iterable
    {
        ...
        yield 'logo' => ['logo'];
        yield 'merchantType' => ['merchantType'];
    }
