 ...
 * @internal
 */
#[CoversClass(SpecCrudController::class)]
#[RunTestsInSeparateProcesses]
final class SpecCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    public function testIndexPageRequiresAuthentication(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/spec');
    ...
    public function testValidationErrors(): void
    {
        ...
        try {
            $crawler = $client->request('GET', '/pinduoduo-api/spec?crudAction=new');
    ...
    public function testSearchFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/spec?query=test');
            $response = $client->getResponse();
    ...
    public function testFilterFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/spec?filters[specId]=1');
            $response = $client->getResponse();
    ...
    public function testDetailPageAccess(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/spec?crudAction=detail&entityId=1');
            $response = $client->getResponse();
    ...
    protected function getControllerService(): SpecCrudController
    {
        return self::getService(SpecCrudController::class);
    }
