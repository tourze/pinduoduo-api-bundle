 ...
 * @internal
 */
#[CoversClass(StockWareSkuCrudController::class)]
#[RunTestsInSeparateProcesses]
final class StockWareSkuCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    public function testIndexPageRequiresAuthentication(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/stock-ware-sku');
    ...
    public function testValidationErrors(): void
    {
        ...
        try {
            $crawler = $client->request('GET', '/pinduoduo-api/stock-ware-sku?crudAction=new');
    ...
    public function testSearchFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/stock-ware-sku?query=test');
            $response = $client->getResponse();
    ...
    public function testFilterFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/stock-ware-sku?filters[quantity]=100');
            $response = $client->getResponse();
    ...
    public function testDetailPageAccess(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/stock-ware-sku?crudAction=detail&entityId=1');
            $response = $client->getResponse();
    ...
    protected function getControllerService(): StockWareSkuCrudController
    {
        return self::getService(StockWareSkuCrudController::class);
    }
