...
final class AccountCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    public function testIndexPageRequiresAuthentication(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/account');
    ...
    public function testValidationErrors(): void
    {
        ...
        try {
            $crawler = $client->request('GET', '/pinduoduo-api/account?crudAction=new');
    ...
    public function testSearchFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/account?query=test');
            $response = $client->getResponse();
    ...
    public function testFilterFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/account?filters[applicationType]=1');
            $response = $client->getResponse();
    ...
    public function testDetailPageAccess(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/account?crudAction=detail&entityId=1');
            $response = $client->getResponse();
    ...
    {
        yield 'title' => ['应用名称'];
        yield 'client_id' => ['Client ID'];
        yield 'application_type' => ['应用类型'];
    }
    ...
    public static function provideNewPageFields(): iterable
    {
        ...
        yield 'client_secret' => ['clientSecret'];
