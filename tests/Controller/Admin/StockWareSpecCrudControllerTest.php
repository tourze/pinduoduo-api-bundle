 ...
 * @internal
 */
#[CoversClass(StockWareSpecCrudController::class)]
#[RunTestsInSeparateProcesses]
final class StockWareSpecCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    public function testIndexPageRequiresAuthentication(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/stock-ware-spec');
    ...
    public function testValidationErrors(): void
    {
        ...
        try {
            $crawler = $client->request('GET', '/pinduoduo-api/stock-ware-spec?crudAction=new');
    ...
    public function testSearchFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/stock-ware-spec?query=test');
            $response = $client->getResponse();
    ...
    public function testFilterFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/stock-ware-spec?filters[specValue]=test');
            $response = $client->getResponse();
    ...
    public function testDetailPageAccess(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/stock-ware-spec?crudAction=detail&entityId=1');
            $response = $client->getResponse();
    ...
    protected function getControllerService(): StockWareSpecCrudController
    {
        return self::getService(StockWareSpecCrudController::class);
    }
