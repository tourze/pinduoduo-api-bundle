 ...
 * @internal
 */
#[CoversClass(LogisticsTemplateCrudController::class)]
#[RunTestsInSeparateProcesses]
final class LogisticsTemplateCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    public function testIndexPageRequiresAuthentication(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/logistics-template');
    ...
    public function testValidationErrors(): void
    {
        ...
        try {
            $crawler = $client->request('GET', '/pinduoduo-api/logistics-template?crudAction=new');
            ...
            if ($response->isSuccessful()) {
                ...
                $crawler = $client->submit($form, [
                    'logistics_template[templateName]' => '',
                ]);
    ...
    public function testSearchFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/logistics-template?query=test');
            $response = $client->getResponse();
    ...
    public function testFilterFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/logistics-template?filters[templateId]=1');
            $response = $client->getResponse();
    ...
    public function testDetailPageAccess(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/logistics-template?crudAction=detail&entityId=1');
            $response = $client->getResponse();
    ...
    protected function getControllerService(): LogisticsTemplateCrudController
    {
        return self::getService(LogisticsTemplateCrudController::class);
    }
