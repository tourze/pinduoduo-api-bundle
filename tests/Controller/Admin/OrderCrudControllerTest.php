...
final class OrderCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    public function testIndexPageRequiresAuthentication(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/order');
    ...
    public function testValidationErrors(): void
    {
        ...
        try {
            $crawler = $client->request('GET', '/pinduoduo-api/order?crudAction=new');
    ...
    public function testSearchFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/order?query=test');
            $response = $client->getResponse();
    ...
    public function testFilterFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/order?filters[orderStatus]=1');
            $response = $client->getResponse();
    ...
    public function testDetailPageAccess(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/order?crudAction=detail&entityId=1');
            $response = $client->getResponse();
    ...
    public static function provideNewPageFields(): iterable
    {
        ...
        yield 'stockOut' => ['stockOut'];
        yield 'preSale' => ['preSale'];
    }
