 ...
 * @internal
 */
#[CoversClass(AuthCatCrudController::class)]
#[RunTestsInSeparateProcesses]
final class AuthCatCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    public function testIndexPageRequiresAuthentication(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/auth-cat');
    ...
    public function testValidationErrors(): void
    {
        ...
        try {
            $crawler = $client->request('GET', '/pinduoduo-api/auth-cat?crudAction=new');
    ...
    public function testSearchFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/auth-cat?query=test');
            $response = $client->getResponse();
    ...
    public function testFilterFunctionality(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/auth-cat?filters[leaf]=1');
            $response = $client->getResponse();
    ...
    public function testDetailPageAccess(): void
    {
        ...
        try {
            $client->request('GET', '/pinduoduo-api/auth-cat?crudAction=detail&entityId=1');
            $response = $client->getResponse();
    ...
    protected function getControllerService(): AuthCatCrudController
    {
        return self::getService(AuthCatCrudController::class);
    }
    ...
    public static function provideIndexPageHeaders(): iterable
    {
        ...
        yield 'cat_id' => ['类目ID'];
        yield 'cat_name' => ['类目名称'];
        yield 'parent_cat_id' => ['上级类目ID'];
        yield 'is_leaf' => ['是否叶子类目'];
    }
    ...
    public static function provideNewPageFields(): iterable
    {
        yield 'mall' => ['mall'];
        yield 'cat_id' => ['catId'];
        yield 'cat_name' => ['catName'];
        yield 'parent_cat_id' => ['parentCatId'];
        yield 'leaf' => ['leaf'];
    }
